...
?>
    <div class="row" id="block1" style ="background:  url(images/baba_s_ayfonom.jpg); background-size: cover;">


        <div class=" check_in">

            <div><object class="make" data="images/makyour.png" ></object>
            </div>
            ...
            <div class="firstcheck_in">
                ...
                <div>
                    <input class="txtbox password check" type ="password" placeholder="Подтвердите пароль">
                </div>
                <div>
                    <input class="txtbox e-box" type="text" placeholder="E-mail">
                </div>
                <div>
                    <a id="reg_btn" class="check_btn btn btn-default" href="main">Зарегистрироваться</a>
                </div>
            ...
            <div class ="secondcheck_in">
                ...
                <a id="enter_btn" class="check_btn btn btn-default" href="main">Войти</a>
...
<div class="block1-zatem"></div>
    <div class="row" id="block1-2">
        ...
        <object class ="polosa" data="images/polosa.png"></object>
            ...
            <div class="col-lg-2 col-lg-offset-2 col-md-3 col-md-offset-1 col-sm-3 col-sm-offset-1 col-xs-12">
                <div class="adbody">
                    <div class="adhead">
                        ...
                        <object class="kartinka" data="images/newpoly1.svg" type="image/svg+xml"></object>
            ...
            <div class=" col-lg-2 col-lg-offset-1 col-md-3  col-sm-3  col-xs-12">
                <div class="adbody">
                    <div class="adhead">
                        ...
                        <object class="kartinka" data="images/newpoly2.svg" type="image/svg+xml"></object>
            ...
            <div class="wh col-lg-2 col-lg-offset-1 col-md-3 col-sm-3 col-xs-12">
                <div class="adbody">
                    <div class="adhead">
                        ...
                        <object class="kartinka" data="images/newpoly3.svg" type="image/svg+xml"></object>
    ...
    <div id="block3" class="row">
        <div class="someone">
            ...
            <div class="width_for_polyg ">
                ...
                <div class="polygon col-lg-2 col-md-2 col-sm-2 col-sx-2 col-lg-offset-1 col-md-offset-1 col-sx-offset-1 polygon">
                    <object  data="images/SHS.png"></object>
                    <p class="name">Шаталина Светлана</p>
                </div>

                <div class="polygon col-lg-2 col-md-2 col-sm-2 col-sx-2 polygon">
                    <object data="images/KA.png"></object>
                    <p class="name">Кубицкий Александр</p>
                </div>

                <div class=" polygon col-lg-2 col-md-2 col-sm-2 col-sx-2 polygon">
                    <object  data="images/KD.png"></object>
                    <p class="name">Корнейчук Денис</p>
                </div>

                <div class="polygon col-lg-2 col-md-2 col-sm-2 col-sx-2 polygon">
                    <object  data="images/YS.png"></object>
                    <p class="name">Серёгин Юрий</p>
                </div>

                <div class="col-lg-2 col-md-2 col-sm-2 col-sx-2 polygon">
                    <object data="images/AS.png"></object>
    ...
    <div class="row">
        <div id="block4">
            <div class="someone">
                ...
                <div class="col-lg-offset-2 col-lg-2 col-md-3 col-md-offset-1 col-sm-4 col-sx-2">
                    <div class="bl4_cont">
                        <div class="data col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h3 class="zagh3">Porshe Cayenne</h3>
                            <div class="circle">
                                <object data="images/porsh.jpg"></object>
                    ...
                    <div class="bl4_cont">
                        <div class="data  col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="circle">
                                <object data="images/aqua.jpg"></object>
                ...
                <div class="col-lg-2 col-md-3 col-md-offset-1 col-sm-4 col-sx-2">
                    <div class="bl4_cont">
                        <div class="data  col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h3 class="zagh3">Canadian Blood Services</h3>
                            <div class="circle">
                                <object data="images/canad.jpg"></object>
                    ...
                    <div class="bl4_cont">
                        <div class="data  col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="circle">
                                <object data="images/scolk.jpg"></object>
                ...
                <div class=" col-lg-2 col-md-3 col-md-offset-1 col-sm-4 col-sx-2">
                    <div class="bl4_cont">
                        <div class="data  col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="circle">
                                <object data="images/perfect.jpg" ></object>
                    ...
                    <div class="bl4_cont">
                        <div class="data  col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="circle">
                                <object data="images/ritter.jpg"></object>
