...
<!--[endif]-->
    ...
    <link rel="shortcut icon" href="images/logotip.ico">
...
<div class="container-fluid">
    ...
    <div id="block5"  class="row">
        ...
        <div class="row col-lg-3 col-lg-offset-3 col-md-5 col-md-offset-2 col-sm-5  col-sm-offset-1 col-xs-12">
            ...
            <object class="col-lg-5 col-md-4 col-sm-6 col-xs-4 " data="images/mark.png"></object>
            <p id="place">
        ...
        <div class=" row col-lg-3  col-lg-offset-1 col-md-5 col-sm-5 col-xs-12">
            ...
            <object class="col-lg-5 col-md-4 col-sm-6 col-xs-4" data="images/@.png"></object>
    ...
    <footer class="row">
        <div class="col-lg-4 col-lg-push-4 col-md-4 col-sm-4 ">
            <p id="copyright">Inuendo©</p>
        </div>
        <div class="col-lg-4 col-lg-pull-4 col-md-4 col-sm-4 ">
            <p><a>inuendo@gmail.com</a></p>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 ">
            <p><a href="#">Наш устав</a></p>
        </div>
    </footer>
